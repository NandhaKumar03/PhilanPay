...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) => WelcumWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => WelcumWidget(),
        ),
        FFRoute(
          name: 'Visualization',
          path: '/visualization',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Visualization')
              : VisualizationWidget(),
        ),
        FFRoute(
          name: 'paymentSuccess',
        ...
        FFRoute(
          name: 'Welcum',
          path: '/welcum',
          builder: (context, params) => WelcumWidget(),
        ),
        FFRoute(
          name: 'PhoneNo',
          path: '/phoneNo',
          builder: (context, params) => PhoneNoWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'PaymentPin',
          path: '/paymentPin',
          builder: (context, params) => PaymentPinWidget(),
        ),
        FFRoute(
          name: 'profile',
          path: '/profile',
